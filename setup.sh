#!/bin/bash
echo "=== Primary WiFi Bridge Setup ==="
echo "This script will configure this Pi as the PRIMARY bridge (MASTER)"
echo ""
...
echo "Running primary bridge configuration..."
./scripts/setup_wifi_bridge.sh primary

echo ""
echo "=== Primary Bridge Setup Complete ==="
echo "Next steps:"
...
echo "4. Set up secondary bridge on other Pi"